                ...
                <v-flex xs12 sm10 offset-sm1 md10 offest-md1 lg10 offset-lg1>
                    ...
                    <div class="scrollsettings" v-if="getCompData">
                        <v-data-table v-model="selected"  :headers="headers"
                            :items="getCompData" :search="search" class="table_des">
...
export default {
    ...
    methods: {
        ...
        apiGetlist(date, selbranch, Selstatus) {
            ...
            this.$http.get(`${process.env.API_URL}/api-competitors/${branchvalue}/${datevalue}/${statusvalue}/${userid.name}`, requestOptions)
                .then(response => {
        ...
        rowClick(data) {
            ...
            this.axios.get(`${process.env.API_URL}/api-competitors/${data.cd_id}`, requestOptions).then(response => {
        ...
        rowUpdate(data) {
            ...
            this.axios.put(`${process.env.API_URL}/api-update_competitors/${data.cd_id}`, {
        ...
        loaddate() {
            ...
            this.axios
                .get(`${process.env.API_URL}/api-competitors`, requestOptions).
                then(response => {
