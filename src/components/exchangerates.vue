      ...
      >
        ...
        >
		 ...
		 <tr width="100%">
			...
			<th width="4%">
			 <v-btn rounded color="primary" dark @click="apiGetData(SetYears,SetMonth)">Get Data</v-btn>
			</th>
			</tr>
			<br><br>			
		   </thead>
  ...
  data: () => ({
   ...
   methods: {
		...
		apiGetData(SetYears,SetMonth){		
			...
			this.axios
          .get(`https://mis.dragarwal.com/mis-exchange-rates/${SetYears}/${SetMonth}`).then(response => {	
